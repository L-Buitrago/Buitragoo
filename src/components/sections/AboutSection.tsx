...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="min-h-screen relative flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto w-full gap-10 sm:gap-14 md:gap-16">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 w-full">
          ...
          <FadeIn delay={0.2} y={30}>
            <ContactButton label={t.contactMe} href="https://wa.me/5538998343021?text=Olá!%20Tenho%20interesse%20na%20criação%20de%20um%20site." />
          </FadeIn>
        </div>
      </div>
    </section>
